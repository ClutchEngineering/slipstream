...
struct FigureCaptionTests {
  ...
  @Test func withText() throws {
    try #expect(renderHTML(FigureCaption("Sales data for Q4 2024")) == "<figcaption>Sales data for Q4 2024</figcaption>")
  }
  ...
  @Test func withNestedContent() throws {
    ...
    }) == "<figcaption>Figure 1: <em>Important chart</em></figcaption>")
  }
  ...
  @Test func withFigure() throws {
    ...
    }) == #"<figure><img src="/chart.png" /><figcaption>Sales data for Q4 2024</figcaption></figure>"#)
  }
}
