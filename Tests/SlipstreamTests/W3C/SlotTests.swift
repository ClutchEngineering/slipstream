...
struct SlotTests {
  ...
  @Test func withText() throws {
    try #expect(renderHTML(Slot("Default content")) == "<slot>Default content</slot>")
  }
  ...
  @Test func withTextAndName() throws {
    try #expect(renderHTML(Slot("Default footer", name: "footer")) == #"<slot name="footer">Default footer</slot>"#)
  }
  ...
  @Test func withNestedContent() throws {
    ...
    }) == #"<slot name="content"><h2>Default Title</h2><p>Default paragraph</p></slot>"#)
  }
}
